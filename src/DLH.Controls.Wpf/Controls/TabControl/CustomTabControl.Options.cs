...
public partial class CustomTabControl
{
    ...
    public static readonly DependencyProperty IsDragPreviewEnabledProperty = DependencyProperty.Register(
        nameof(IsDragPreviewEnabled), typeof(bool), typeof(CustomTabControl), new PropertyMetadata(true, CancelOnConfigurationChange));
    ...
    public static readonly DependencyProperty IsAnimationEnabledProperty = DependencyProperty.Register(
        nameof(IsAnimationEnabled), typeof(bool), typeof(CustomTabControl), new PropertyMetadata(true, CancelOnConfigurationChange));
    ...
    public static readonly DependencyProperty DragAnimationDurationProperty = DependencyProperty.Register(
        nameof(DragAnimationDuration), typeof(TimeSpan), typeof(CustomTabControl), new PropertyMetadata(TimeSpan.FromMilliseconds(180), CancelOnConfigurationChange),
    ...
    public static readonly DependencyProperty DragPreviewOpacityProperty = DependencyProperty.Register(
        nameof(DragPreviewOpacity), typeof(double), typeof(CustomTabControl), new PropertyMetadata(0.94d, CancelOnConfigurationChange),
    ...
    public static readonly DependencyProperty MinimumDragDistanceProperty = DependencyProperty.Register(
        nameof(MinimumDragDistance), typeof(double), typeof(CustomTabControl), new PropertyMetadata(5d, CancelOnConfigurationChange),
